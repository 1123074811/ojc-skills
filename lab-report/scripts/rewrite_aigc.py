...
def get_prompt(prompt_num=1, content=""):
    """
    获取降AIGC率提示词
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("用法：python rewrite_aigc.py <content> [prompt_num]")
        print("示例：python rewrite_aigc.py '这是一段需要改写的文本' 1")
        sys.exit(1)
    
    content = sys.argv[1]
    prompt_num = int(sys.argv[2]) if len(sys.argv) > 2 else 1
